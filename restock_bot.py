...
def check_target_store_stock(tcin, store_id):
    url = f"https://redsky.target.com/redsky_aggregations/v1/web/pdp_fulfillment_v1"
    params = {
        "key": "9f36aeafbe60771e321a7cc95a78140772ab3e96",
        "tcin": tcin,
        "store_id": store_id,
        "store_positions_store_id": store_id,
        "has_pricing_store_id": store_id,
        "zip": ZIP_CODE,
        "state": "CT",
        "latitude": "41.8009",
        "longitude": "-73.1287",
    ...
    try:
        ...
        data = response.json()
        store_info = data.get("data", {}).get("fulfillment", {}).get("store_options", [])
